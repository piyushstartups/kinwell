...
export const ViewIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 7l-6.586 6.586a2 2 0 000 2.828l6.586 6.586a2 2 0 002.828-2.828L13.828 12l4.586-4.586a2 2 0 00-2.828-2.828z" transform="rotate(135 12 12)" />
    </svg>
);
