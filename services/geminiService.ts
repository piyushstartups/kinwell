...
// This is the correct, secure way to access the API key in a Vite project for deployment.
const apiKey = import.meta.env.VITE_GEMINI_API_KEY as string;

// A check to ensure the key is present.
if (!apiKey) {
...
export const getHealthSummary = async (
  ...
  if (!apiKey) return "API Key is not configured. Please check the application setup.";
